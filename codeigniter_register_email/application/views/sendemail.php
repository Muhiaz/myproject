...
<html lang="en">
  ...
  <section id="container" class=""> 
                                ...
                                if($fetch_logo->num_rows()>0){
                                  foreach ($fetch_logo->result() as $row) {
                                    ...
                                    <!-- <img src='"<php echo base_url().'images/'.$image_name?>"'>; -->
                                     <img src="<?php echo base_url() .'uploads/' .$image_name ?>" style="width: 40px; height: 40px;">
                                      <?php
                                    }
                                  }
                                }?></span></a></li>
      ...
      <section id="main-content">
          <section class="wrapper"> 
			  <div class="row container" >
				<div class="col-lg-8" style="background-color: #fff;margin-left: 18%;">
      ...
      <address contenteditable>
        <form method="post" action="<?php echo base_url(); ?>user/sendemail" enctype="multipart/form-data">
        <?php 
                                if($fetch_logo->num_rows()>0){
                                  foreach ($fetch_logo->result() as $row) {
                                    $image_arr = explode(",", $row->logo);
                                    foreach($image_arr as $image_name) 
                                    {
                                      ...
                                      ?>
                                    <!-- <img src='"<php echo base_url().'images/'.$image_name?>"'>; -->
                                     <img src="<?php echo base_url() .'uploads/' .$image_name ?>" style="width: 130px; height: 130px;margin-left:200px;margin-top:20px ">
                                      <?php
                                    }
                                  }
                                }?> <?php 
          if($fetch_company->num_rows()>0){
            foreach ($fetch_company->result() as $row) {
              ...
              echo "<p style='text-transform:uppercase;font-family:lato;font-size:20px;margin-top:50px'>$row->companyname</p>";
              echo "<p style='font-family:lato;font-size:16px;'>$row->companyemail,</p>";
              echo "<p style='font-family:lato;font-size:16px;'>$row->companyphone,</p>";
            }
          }
         ?>
      </address>
     ...
     if($fetch_clients->num_rows()>0){
      foreach ($fetch_clients->result() as $row) {
        ?>
       <tr>
          <p><?php echo "Dear " . $row->firstname .","; ?></td></p>
    ...
    <?php
     ...
     <div class="form-group">
      Subject:<input type="text" placeholder="REF:" name="subject" class="form-control">
       <label></label>
       <textarea class="form-control" placeholder="Message" name="emailbody"></textarea>
     </div>
     <div class="form-group">
      ...
      <button class="btn btn-success"><h6 style="font-weight: 1000;">Submit</h6></button>
     </form>
