    ...
    <div class="container body">
      <div class="main_container">
        ...
        <div class="right_col" role="main">
          ...
          <a href="#"><button class="dropbtn1" data-toggle="modal" data-target="#modal1" style="float: left;">Add Expense</button></a>
          <!-- Modal -->
            ...
            <div class="modal-dialog">
              <div class="modal-content modal-content-one">
                <div class="modal-header">
                  ...
                  <h4 class="modal-title" id="myModalLabel" style="text-align: center;color: #000;"><b>Add Expense</b></h4>
                   <?php
     ...
     if($fetch_expenses->num_rows()>0){
      foreach ($fetch_expenses->result() as $row) {
        ?>
        <tr  class="clickable-row" data-href="<?php echo base_url("user/voucher/{$row->id}", "",['class'=>'']); ?>">
          ...
          <td><?php echo $row->paymentmode;  ?>
          <td><?php 
          if($row->amount>0){
            ?>
            <a href="<?php echo base_url('user/updateexpense/'.$row->id); ?>"><button type="submit" id="reverse" class="reverse">
             Reverse
           </button></a>
           <?php
          }
            ...
            ?>
            <a href="<?php echo base_url('user/deleteexpense/'.$row->id); ?>"><button type="submit" id="delete" class="delete">
             delete
           </button></a>
            <a href="<?php echo base_url('user/editexpense/'.$row->id); ?>"><button type="submit" id="edit" class="edit">
             edit
           </button></a>
           <?php
          }
