...
.dropdown:hover .dropbtn {background-color: #394a59;}
  ...
  <section id="container" class=""> 
      ...
      <section id="main-content">
        ...
        <div class="container" style="background-color: #fff; border-radius: 0px;box-shadow: 2px 2px 2px 2px #8888;padding: 3px;margin-top: 10vh; width: 90%;border-radius: 20px;">
        <div class="row">
        <div class="col-md-4" >
          <?php 
                                if($fetch_logo->num_rows()>0){
     ...
     if(count($clients)){
      foreach ($clients as $client) {
        ...
        <tr><th style="padding: 10px;">
         ...
         <tr><th style="padding: 10px;">
                <time datetime="08:30:00">Client Email:</time>
              </th>
              <td class="schedule-offset" colspan="2" style="padding: 10px;">
                <?php echo $row->email; ?>
              </td></tr>
         ...
         <tr><th style="padding: 10px;">
              ...
              <td class="schedule-offset" colspan="2" style="padding: 10px;">
               ...
               <tr><th style="padding: 10px;">
                <time datetime="08:30:00">State:</time>
              </th>
              <td class="schedule-offset" colspan="2" style="padding: 10px;">
                <?php echo $row->state; ?>
              </td></tr>
               <tr><th style="padding: 10px;">
                <time datetime="08:30:00">Town:</time>
              </th>
              <td class="schedule-offset" colspan="2" style="padding: 10px;">
                <?php echo $row->town; ?>
              </td></tr><td>
