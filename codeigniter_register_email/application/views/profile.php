...
<html lang="en">
  ...
  <section id="container-fluid" > 
      ...
      <section id="main-content">
        ...
        <div class="container" style="background-color: #fff; border-radius: 0px;box-shadow: 5px 5px 5px 5px #8888;width: 91%;margin-top: 10vh;border-radius: 20px;padding: 30px;">
        <div class="row">
        <div class="col-md-5" >
          ...
          if($fetch_company->num_rows()>0){
            foreach ($fetch_company->result() as $row) {
              echo "<span style='text-transform:uppercase;font-family:lato;font-size:25px;margin:100px;'>$row->companyname</span>";
            }
          }
    ...
    <?php
     ...
     ?>
        <h1 style="text-transform: uppercase;"><?php echo $client->companyname; ?> Details</h1>
          ...
          <thead>
            <tr >
              <th style="padding: 10px;text-align: center;">
                <time datetime="08:30:00">Company Name:</time>
              </th>
          ...
          <tbody>
            <tr>
              <th scope="row" style="padding: 10px;">
               <time datetime="08:30:00"> Company Phone:</time>
              </th>
              <td class="schedule-offset" colspan="2" style="padding: 10px;">
                <?php echo $client->companyphone; ?>
              </td>
            </tr>
            <tr>
              <th scope="row" style="padding: 10px;">
                <time datetime="08:30:00">Company Email:
              </th>
              <td style="padding: 10px;">
                  <!-- <h4><?php echo $client->companyname; ?></h4> -->
                  <?php echo $client->companyemail; ?>
                </a>
              </td>
            </tr>
            <tr>
              ...
              <td class="schedule-offset" colspan="2" style="padding: 10px;">
                <?php echo $client->companylocation; ?>
              </td>
            </tr>
             <tr>
              <th scope="row" style="padding: 10px;">
               <time datetime="08:30:00"> County:</time>
              </th>
              <td class="schedule-offset" colspan="2" style="padding: 10px;">
             ...
             <tr>
              <th scope="row" style="padding: 10px;">
               <time datetime="08:30:00">Street Address:</time>
              </th>
              <td class="schedule-offset" colspan="2" style="padding: 10px;">
             ...
             <tr>
              <th scope="row" style="padding: 10px;">
               <time datetime="08:30:00">Postal Code:</time>
              </th>
              <td class="schedule-offset" colspan="2" style="padding: 10px;">
            ...
            <tr>
              <th scope="row" style="padding: 10px;">
                <time datetime="14:00">Company Website:</time>
              </th>
              <td style="padding: 10px;">
                <a href="speakers.html#tessa-harmon">
                  <!-- <h4><?php echo $client->companyname; ?></h4> -->
                  <?php echo $client->companywebsite; ?>
                </a>
              </td>

              <td><?php echo anchor("user/editcompany/{$client->id}", "Edit",['class'=>'btn btn-primary']); ?><div id="myModal" class="modal fade" role="dialog"></td>
            </tr>
            <tr>
            </tr>
          </tbody>
