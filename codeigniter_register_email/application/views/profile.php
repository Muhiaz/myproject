...
.dropdown:hover .dropbtn {background-color: #394a59;}
  ...
  <section id="container-fluid" > 
      ...
      <section id="main-content">
        ...
        <div class="container" style="background-color: #fff; border-radius: 0px;box-shadow: 5px 5px 5px 5px #8888;width: 91%;margin-top: 10vh;border-radius: 10px;padding: 30px;">
        <div class="row">
        <div class="col-md-5" >
