  ...
  <section id="container" class=""> 
      ...
      <section id="main-content">
        <section class="wrapper">
          <h2 style='font-family:lato;font-size:25px;font-weight: 500;color: #000;'>Assets Report</h2>
            <form id="form-filter" class="form-horizontal">
             ...
             <input type="text" name="enddate" id="enddate" class="form-control">
                        ...
                        <div class="col-md-4">
                            ...
                            <a href="allassetsreport"><button type="button" id="btn-reset" class="dropbtn5">All Assets Report</button></a>
      </div>
      </div>
                          </div>
                </form><br>
          ...
          ?>
          <h6 style='font-family:lato;font-size:20px;text-align:center'>Total Assets</h6>
          </div>
   ...
   var table = $('#invoicestable').DataTable({
    "processing": true, //Feature control the processing indicator.
        ...
        // Load data for the table's content from an Ajax source
            "ajax": {
            "url": "<?php echo base_url('crudassets/ajax_list')?>",
            "type": "POST",
            "draw":"draw"
