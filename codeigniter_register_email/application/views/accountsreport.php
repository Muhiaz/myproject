  ...
  <section id="container" class=""> 
      ...
      <section id="main-content">
        <section class="wrapper">
          <h2 style='font-family:lato;font-size:25px;font-weight: 500;color: #000;'>Income Report</h2>
          ...
          ?>
          <h6 style='font-family:lato;font-size:20px;text-align:center'>Total Income</h6>
          </div>
   ...
   var table = $('#invoicestable').DataTable({
    "processing": true, //Feature control the processing indicator.
        ...
        // Load data for the table's content from an Ajax source
            "ajax": {
            "url": "<?php echo base_url('totalincomecontroller/ajax_list')?>",
            "type": "POST",
            "draw":"draw"
