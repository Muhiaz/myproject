...
<html lang="en">
  ...
  <section id="container-fluid" class=""> 
      ...
      <section id="main-content">
        ...
        <div class="container" style="background-color: #fff; border-radius: 0px;box-shadow: 2px 1px 1px 1px #8888;padding: 50px;width: 91%;margin-top: 15vh;border-radius: 20px">
        <div class="row">
        <div class="col-md-5" >
          ...
          <?php 
                                if($fetch_serviceimage->num_rows()>0){
                                  foreach ($fetch_serviceimage->result() as $row) {
                                    $image_arr = explode(",", $row->serviceimage);
                                    foreach($image_arr as $image_name) 
                                    {
                                       // echo base_url() .'uploads/' .$image_name;
                                      ?>
    ...
    <?php
     ...
     if(count($services)){
      foreach ($services as $row) {
        ?>
        <table style="margin-left: 15%" class="stripped">
        <thead>
            <tr >
              <th style="padding: 10px;text-align: center;">
                <time datetime="08:30:00">Service Name:</time>
              </th>
          ...
          <tbody>
            <tr>
              <th scope="row" style="padding: 10px;">
               <time datetime="08:30:00"> Service Category:</time>
              </th>
              <td class="schedule-offset" colspan="2" style="padding: 10px;">
                <?php echo $row->servicecategory; ?>
              </td>
            </tr>
            <tr>
              <th scope="row" style="padding: 10px;">
                <time datetime="08:30:00">Purchase Information:
              </th>
              <td style="padding: 10px;">
                  <!-- <h4><?php echo $client->companyname; ?></h4> -->
                  <?php echo $row->purchaseinformation; ?>
                </a>
              </td>
            </tr>
            <tr>
              ...
              <td class="schedule-offset" colspan="2" style="padding: 10px;">
                <?php echo $row->salesinformation; ?>
              </td>
            </tr>
             <tr>
              <th scope="row" style="padding: 10px;">
               <time datetime="08:30:00"> Service Description:</time>
              </th>
              <td class="schedule-offset" colspan="2" style="padding: 10px;">
             ...
             <tr>
              <th scope="row" style="padding: 10px;">
               <time datetime="08:30:00">Charge:</time>
              </th>
              <td class="schedule-offset" colspan="2" style="padding: 10px;">
            ...
            <tr>
              <td><?php echo anchor("user/editserviceprofile/{$row->id}", "Edit",['class'=>'btn btn-primary']); ?><div id="myModal" class="modal fade" role="dialog"></td>
            </tr>
            <tr>
            </tr>
          </tbody>
