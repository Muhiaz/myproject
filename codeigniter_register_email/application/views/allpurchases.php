    ...
    <div class="container body">
      <div class="main_container">
        ...
        <div class="right_col" role="main">
          ...
          <a href="#"><button class="dropbtn1" data-toggle="modal" data-target="#modal1" style="float: left;">Add Purchase</button></a>
          <!-- Modal -->
            ...
            <div class="modal-dialog">
              <div class="modal-content modal-content-one">
                <div class="modal-header">
                  ...
                  <h4 class="modal-title" id="myModalLabel" style="text-align: center;color: #000;"><b>Add Purchase</b></h4>
                   <?php
          ...
          <!-- top tiles -->
         <!--  <a href="<?php echo base_url('user/suppliers'); ?>"><button class="dropbtn1">Suppliers</button></a> -->
     ...
     if($fetch_purchases->num_rows()>0){
      foreach ($fetch_purchases->result() as $row) {
        ?>
        <tr>
          ...
          if($row->amount>0){
            ?>
            <a href="<?php echo base_url('user/updatepurchase/'.$row->id); ?>"><button type="submit" id="reverse" class="bankbtn">
             Reverse
           </button></a>
           <?php
          }
            ...
            ?>
            <a href="<?php echo base_url('user/deletepurchase/'.$row->id); ?>"><button type="submit" id="delete" class="dropbtn0">
             delete
           </button></a>
            <a href="<?php echo base_url('user/editpurchase/'.$row->id); ?>"><button type="submit" id="edit" class="pettybtn">
             edit
           </button></a>
           <?php
          }
