...
<div class="col-xs-6 col-md-6 " id="first-child">
          <a href="#"><button class="dropbtn1" data-toggle="modal" data-target="#modal1" style="margin-left: 100%">Add Purchase</button></a>
          <!-- Modal -->
            ...
            <div class="modal-dialog">
              <div class="modal-content modal-content-one">
                <div class="modal-header">
                  ...
                  <h4 class="modal-title" id="myModalLabel" style="text-align: center;"><b>Add Purchase</b></h4>
                   <?php
      ...
      foreach ($fetch_purchases->result() as $row) {
        ...
        <tr>
          ...
          <td><?php echo $row->date;  ?></td>
           <td><?php echo anchor("user/clientinvoice/{$row->id}", "Delete",['class'=>'dropbtn2']); ?></td>
          <td></td>
        </tr>
        <?php
      }
