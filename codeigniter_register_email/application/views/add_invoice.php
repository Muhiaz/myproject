  ...
  <section id="container" class=""> 
      ...
      <section id="main-content">
          <section class="wrapper">            
              <div class="row">
                <div class="col-lg-12">
                 <form method="post" action="<?php echo base_url()?>user/addinvoice" style="border: 1px solid #fff;padding: 20px; width:80%; box-shadow: 5px 5px 5px 5px #8888">
     <h3 class="page-header">Add invoice</h3>
                    <div>
                    <div class="form-group">
                    <label>Invoice Number</label>
                    <input type="text" name="invoicenumber" class="form-control col-md-6"/>
                    <span class="text-danger"><?php echo form_error("invoicenumber"); ?></span>
                    </div><br>
                    <div class="form-group">
                    <label>Client Name</label>
                    <!-- <input type="text" name="clientname" class="form-control col-md-6"/> -->
                  <select name="clientname">
                    ...
                    <input type="text" name="clientphone" class="form-control col-md-6"/>
                    <span class="text-danger"><?php echo form_error("clientphone"); ?></span>
                    <span class="text-danger"></span>
                    </div>
                    <div class="form-group">
                    <label>Client Email</label>
                    <input type="text" name="clientemail" class="form-control col-md-6 col-md-6"/><?php if(isset($row->firsname)){
                      echo $row->clientemail;
                    }
                    ?>
                     <span class="text-danger"><?php echo form_error("clientemail"); ?></span>
                    </div>
                     <div class="form-group">
                    <label>Product</label>
                    ...
                    <input type="text" name="productdescription" class="form-control col-md-6"/>
                     <span class="text-danger"><?php echo form_error("productdescription"); ?></span>
                    </div>
                    <div class="form-group">
                    <label>Product Quantity</label>
                    <input type="" name="productquantity" class="form-control col-md-6"/>
                     <span class="text-danger"><?php echo form_error("productquantity"); ?></span>
                    </div>
                     <div class="form-group">
                    <label>Date Given</label>
                    <input type="Date" name="dategiven" class="form-control col-md-6"/>
                     <span class="text-danger"><?php echo form_error("dategiven"); ?></span>
                    </div>
                     <div class="form-group">
