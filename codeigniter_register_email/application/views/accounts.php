  ...
  <body class="nav-md">
    <div class="container body">
      ...
      <div class="col-md-3" style="background-color: #800000;color: #fff;text-align: center;">
        <h2><?php if($gettotalincome->num_rows()>0){
                foreach ($gettotalincome->result() as $value) {
                  echo "<h3><b>";
                  echo "Kshs. ";
                  print_r($value->amountpaid);
                   echo "</b></h3>";
                }
              }?></h2>
        <h5><b>Total Income</b></h5>
          ...
          <!-- top tiles -->
          <h2 style="text-align: center;">Income Account</h2>
    ...
    <script type="text/javascript">
     ...
     //Feature control DataTables' server-side processing mode.
        ...
        // Load data for the table's content from an Ajax source
            "ajax": {
            "url": "<?php echo site_url('incomeaccountreport/ajax_list')?>",
            "type": "POST",
        },
