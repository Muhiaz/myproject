...
.show {display:block;}
  ...
  <span class="caret"></span>Add Supplier</button>
  <ul class="dropdown-menu">
    <li><a href="add_supplier"><button type="button" class="btn btn-colorless" data-toggle="modal" data-target="#myModal" >Company</button></a></li>
    <li><a href="add_supplier"><button type="button" class="btn btn-colorless" data-toggle="modal" data-target="#exampleModal">Individual</button></a></li>
...
<?php
 ...
 <form method="post" action="<?php echo base_url()?>user/add_suppliercompany">
       <div class="form-row">
...
<div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
  <div>
     <form method="post" action="<?php echo base_url()?>user/add_supplier">
       <div class="form-row">
    <div class="form-group col-md-6">
    ...
    <div class="form-group col-md-6">
      ...
      <input type="text" class="form-control" id="inputPassword4" placeholder="" name="secondname">
    </div>
  </div>
  ...
  <div class="form-row">
    ...
    <div class="form-group col-md-6">
      <label for="inputEmail4">Town</label>
      <input type="text" class="form-control" id="inputEmail4" placeholder="Email" name="town">
    </div>
  </div>
  <div class="form-row">
    <div class="form-group col-md-6">
...
<div class="container">          
  <table class="table table-striped" style="margin-left:20%;">
    <h3 style="margin-left:50%;">Individual Suppliers</h3>
    <thead>
      <tr>
        <th>Supplier Name</th>
     ...
     if($fetch_supplier->num_rows()>0){
      foreach ($fetch_supplier->result() as $row) {
       ...
       <tr>
          ...
          <td><?php echo anchor("user/viewsupplier/{$row->id}", "View Supplier",['class'=>'dropbtn1',]); ?></td>
        </tr>
        <?php
      }
     }
  ...
  <h3 style="margin-left:50%;">Supplier Companies</h3>
  <table class="table table-striped" style="margin-left:20%;">
    <thead>
      <tr>
        <th>Supplier Name</th>
    ...
    <tbody>
     <?php
     if($fetch_suppliercompany->num_rows()>0){
      foreach ($fetch_suppliercompany->result() as $row) {
        ?>
       <tr>
          ...
          <td><?php echo anchor("user/sendemail/", "Send Email",['class'=>'dropbtn']); ?>
          <td><?php echo anchor("user/viewsuppliercompany/{$row->id}", "View Supplier",['class'=>'dropbtn1',]); ?></td>
        </tr>
        <?php
      }
     }
