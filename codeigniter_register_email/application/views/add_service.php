...
<script type="text/javascript" src="<?php echo base_url('js/jquery.ba-hashchange.min.js');?>"></script>
 <link href="<?php echo base_url('css/main1.css');?>" rel="stylesheet">
  ...
  <section id="container" class=""> 
     ...
     <?php echo form_open_multipart('user/addservice') ?>
     <h3 class="page-header h3">Add Service</h3>
                    <div class="form-row">
                    <div class="col-md-6 form-group">
                    <label>Name</label>
                    <input type="text" name="servicename" class="form-control col-md-6"/>
                    <span class="text-danger"><?php echo form_error("servicename"); ?></span>
                    </div>
                    <div class="col-md-6 form-group">
                    <label>Service Category</label>
                   <!--  <input type="" name="productcategory" class="form-control col-md-6"/> -->
                   <select name="servicecategory" class="form-control col-md-6">
                     <option>Select Category</option>
                     <option>Inventory</option>
                     <option>Non-Inventory</option>
                     <option></option>
                   </select>
                    <span class="text-danger"><?php echo form_error("servicecategory"); ?></span>
                  ...
                  <div class="form-row">
                    ...
                    <input type="text" name="purchaseinformation" class="form-control col-md-6"/>
                    <span class="text-danger"><?php echo form_error("purchaseinformation"); ?></span>
                    </div>
                    <div class="col-md-6 form-group">
                    <label>Sales Information</label>
                    <input type="text" name="salesinformation" class="form-control col-md-6"/>
                    <span class="text-danger"><?php echo form_error("salesinformation"); ?></span>
                    </div>
                  </div>
                  <div class="form-row">
