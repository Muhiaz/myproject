                   ...
                   <?php 
                        ...
                        <div style="justify-content: center;text-align: center;">
                            ...
                            <br><br>
                             ...
                             <h2 style="text-align: center;">ASSETS REPORT</h2><br> 
                        </div>
                    ...
                    <table>
                      <tr>
                        ...
                        <td></td>
                        <td></td>
                        <td>Total Credit Puchases:
                          <?php if($getunpaidpurchases->num_rows()>0){
              foreach ($getunpaidpurchases->row() as $row) {
                echo "  Kshs. ";
                print_r($row);
              }
            }?>
                      ...
                      <tr>
                        ...
                        <td></td>
                        <td></td>
                        <td>Total Cash Purchases:
                          <?php if($getpaidpurchases->num_rows()>0){
              foreach ($getpaidpurchases->row() as $row) {
                echo "  Kshs. ";
                print_r($row);
              }
            }?>
                      ...
                      <tr>
                        ...
                        <td></td>
                        <td>Total Purchases:
                          <?php if($getpurchases->num_rows()>0){
              foreach ($getpurchases->row() as $row) {
                echo "  Kshs. ";
                print_r($row);
              }
            }?>
