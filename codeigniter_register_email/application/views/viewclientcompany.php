  ...
  <section id="container" class=""> 
      ...
      <section id="main-content">
          <section class="wrapper" > 
            <div class="container" style="background-color: #fff; border-radius: 0px;box-shadow: 1px 1px 1px 1px #8888;padding: 3px;margin-top: 8vh;">
          <div class="row">
        <div class="col-lg-4">
                                ...
                                if($fetch_logo->num_rows()>0){
                                  foreach ($fetch_logo->result() as $row) {
                                    ...
                                    foreach($image_arr as $image_name) 
                                    {
                                      ...
                                      ?>
                                    <!-- <img src='"<php echo base_url().'images/'.$image_name?>"'>; -->
                                     <img src="<?php echo base_url()?>/images/img_avatar.png" style="width: 250px; height: 250px;margin-left:40px;margin-top: 50px;">
                                      <?php
                                    }
                                  }
                                }?> <?php 
          if(count($clients)){
            foreach ($clients as $row) {
              echo "<span style='text-transform:uppercase;font-family:lato;font-size:40px;margin:100px;'>$row->name</span>";
            }
          }
    ...
    <?php
     ...
     ?>
        <h1 style="text-transform: uppercase;"><?php echo $client->name. 's'; ?> Details</h1>
     ...
     if(count($clients)){
      foreach ($clients as $client) {
        ...
        <tr><th style="padding: 10px;">
                <time datetime="08:30:00">Email:</time>
              </th>
              <td class="schedule-offset" colspan="2" style="padding: 10px;">
                <?php echo $row->email; ?>
              </td></tr>
         <tr><th style="padding: 10px;">
                <time datetime="08:30:00">Phone Number:</time>
              </th>
              <td class="schedule-offset" colspan="2" style="padding: 10px;">
                <?php echo "0". $row->phonenumber; ?>
              </td></tr>
         <tr><th style="padding: 10px;">
              ...
              <td class="schedule-offset" colspan="2" style="padding: 10px;">
               ...
               <tr><th style="padding: 10px;">
                <time datetime="08:30:00">Count/State:</time>
              </th>
              <td class="schedule-offset" colspan="2" style="padding: 10px;">
                <?php echo $row->state; ?>
              </td></tr>
              ...
              <td>
          <?php echo anchor("user/editclient/" .$client->id, "Edit",['class'=>'btn btn-primary',]); ?></td>
        </tr>
        <?php
      }
     }
