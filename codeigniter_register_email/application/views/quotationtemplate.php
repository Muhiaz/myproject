...
<div id="invoice" class="container">
    ...
    <div class="invoice overflow-auto">
                ...
                <div class="row"style="justify-content: center;">
                   <?php 
                       ...
                       <div class="" style='margin-left: 55%;'>
                        <h4 class="invoice-id">Quotation <?php
                                 if($fetch_editquotation->num_rows()>0){
                                  foreach ($fetch_editquotation->result() as $row) {
        ...
        <div class="col-md-6">
         ...
         <div class="col-md-6">
         <textarea class="form-control" placeholder="Attachments"></textarea>
         </div>
       </div>
