                   ...
                   <?php 
                        ...
                        <div style="justify-content: center;text-align: center;">
                            ...
                            <br><br>
                             ...
                             <h2 style="text-align: center;">INVOICE REPORT</h2><br> 
                        </div>
                       ...
                       <?php
                        ...
                        ?>
                          <tr>
                            ...
                            <td><?php echo $row->amountpaid."<br>";?></td>
                              <td><?php echo $row->dateofreceipt."<br>";?></td>
                              <td><?php echo $row->modeofpayment."<br>";?></td>
                              <td><?php echo $row->note."<br>";?></td>
                          </tr>
                        </tbody>
                        <?php
                      }
