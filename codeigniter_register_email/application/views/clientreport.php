            ...
            <div class="panel-body">
             ...
             <input name="max" id="max" class="form-control">
                        ...
                        <div class="col-md-2">
                            ...
                            <input type="text" class="form-control" id="clientname"><br>
   ...
   var table = $('#invoicestable').DataTable({ 
     ...
     //Feature control DataTables' server-side processing mode.
        ...
        // Load data for the table's content from an Ajax source
            "ajax": {
            "url": "<?php echo site_url('clientreport/ajax_list')?>",
            "type": "POST",
            "data": function ( data ) {
        ...
        dom: 'lBfrtip',
           buttons: [
                ...
                $(table.rows().nodes()).click( function () {
                    ...
                    //redirect
                    document.location.href = "clientindividualreport/" + aData.name;
                } );
            },
                  responsive: {
            details: {
