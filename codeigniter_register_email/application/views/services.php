  ...
  <section id="container" class=""> 
      ...
      <section id="main-content">
          <section class="wrapper">            
			  <div class="row">
				<div class="col-lg-12">
					<h3 class="page-header" style="margin-left: 45%;">Services</h3>
          <?php ?>
				</div>
			</div>			 
           </div> 
  <a href="<?php echo base_url();?>user/addservice"><button class="btn btn-primary" type="button" style="margin-left: 75%;">Add Service
  </button></a>
		  <!-- Today status end -->
			<div class="row">
       ...
       foreach ($fetch_service->result() as $row) {
         ...
         <tr>
           ...
           <td><?php echo $row->unitprice;  ?></td>
                                ...
                                <td><?php echo anchor("user/viewservice/{$row->id}","View Service",['class'=>'btn btn-primary']);?></td>
         </tr>
         <?php
       }
     }
